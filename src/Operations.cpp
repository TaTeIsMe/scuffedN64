...
void Ccondfmt(VR4300Cycle &cpu)
{
 ...
 VR4300Cycle::OperationTemplate primary_op_lut[64]{
    ...
    /*03*/ {JAL, CAUSES_BRANCH_DELAY | STORES_IN_31 | WRITES_REG, 0, 0, 0, OpType::JAL},
    /*04*/ {BEQ, CAUSES_BRANCH_DELAY, 0, 0, 0, OpType::BEQ},
    /*05*/ {BNE, CAUSES_BRANCH_DELAY, 0, 0, 0, OpType::BNE},
    /*06*/ {BLEZ, CAUSES_BRANCH_DELAY, 0, 0, 0, OpType::BLEZ},
    /*07*/ {BGTZ, CAUSES_BRANCH_DELAY, 0, 0, 0, OpType::BGTZ},
    /*08*/ {ADDI, WRITES_REG | STORES_IN_RT | CAUSES_OVERFLOW_EXCEPTION, 0, 0, 0, OpType::ADDI},
    /*09*/ {ADDIU, WRITES_REG | STORES_IN_RT, 0, 0, 0, OpType::ADDIU},
    /*0A*/ {SLTI, WRITES_REG | STORES_IN_RT, 0, 0, 0, OpType::SLTI},
    /*0B*/ {SLTIU, WRITES_REG | STORES_IN_RT, 0, 0, 0, OpType::SLTIU},
    /*0C*/ {ANDI, WRITES_REG | STORES_IN_RT, 0, 0, 0, OpType::ANDI},
    /*0D*/ {ORI, WRITES_REG | STORES_IN_RT, 0, 0, 0, OpType::ORI},
    /*0E*/ {XORI, WRITES_REG | STORES_IN_RT, 0, 0, 0, OpType::XORI},
    ...
    /*16*/ {BLEZL, CAUSES_BRANCH_DELAY, 0, 0, 0, OpType::BLEZL},
    /*17*/ {BGTZL, CAUSES_BRANCH_DELAY, 0, 0, 0, OpType::BGTZL},
    /*18*/ {DADDI, WRITES_REG | STORES_IN_RT | CAUSES_OVERFLOW_EXCEPTION, 0, 0, 0, OpType::DADDI},
    /*19*/ {DADDIU, WRITES_REG | STORES_IN_RT, 0, 0, 0, OpType::DADDIU},
    /*1A*/ {LDL, IS_LOAD | LEFT_ACCESS | WRITES_REG | STORES_IN_RT, 0, 8, 0, OpType::LDL},
    /*1B*/ {LDR, IS_LOAD | RIGHT_ACCESS | WRITES_REG | STORES_IN_RT, 0, 8, 0, OpType::LDR},
    /*1C*/ {},
    /*1D*/ {},
    /*1E*/ {},
    /*1F*/ {},
    /*20*/ {LB, IS_LOAD | SIGN_EXTENDED | WRITES_REG | STORES_IN_RT | SIGN_EXTENDED, 0, 1, 0, OpType::LB},
    /*21*/ {LH, IS_LOAD | SIGN_EXTENDED | WRITES_REG | STORES_IN_RT | SIGN_EXTENDED, 0, 2, 0, OpType::LH},
    /*22*/ {LWL, IS_LOAD | WRITES_REG | STORES_IN_RT | LEFT_ACCESS | SIGN_EXTENDED, 0, 4, 0, OpType::LWL},
    /*23*/ {LW, IS_LOAD | SIGN_EXTENDED | WRITES_REG | STORES_IN_RT, 0, 4, 0, OpType::LW},
    /*24*/ {LBU, IS_LOAD | WRITES_REG | STORES_IN_RT, 0, 1, 0, OpType::LBU},
    /*25*/ {LHU, IS_LOAD | WRITES_REG | STORES_IN_RT, 0, 2, 0, OpType::LHU},
    /*26*/ {LWR, IS_LOAD | WRITES_REG | STORES_IN_RT | RIGHT_ACCESS | SIGN_EXTENDED, 0, 4, 0, OpType::LWR},
    /*27*/ {LWU, IS_LOAD | WRITES_REG | STORES_IN_RT, 0, 4, 0, OpType::LWU},
    /*28*/ {SB, IS_STORE, 0, 1, 0, OpType::SB},
    /*29*/ {SH, IS_STORE, 0, 2, 0, OpType::SH},
    /*2A*/ {SWL, IS_STORE | LEFT_ACCESS, 0, 4, 0, OpType::SWL},
    /*2B*/ {SW, IS_STORE, 0, 4, 0, OpType::SW},
    /*2C*/ {SDL, IS_STORE | LEFT_ACCESS, 0, 8, 0, OpType::SDL},
    /*2D*/ {SDR, IS_STORE | RIGHT_ACCESS, 0, 8, 0, OpType::SDR},
    /*2E*/ {SWR, IS_STORE | RIGHT_ACCESS, 0, 4, 0, OpType::SWR},
    /*2F*/ {CACHE, 0, 0, 0, 0, OpType::CACHE}, // CACHE uses base (rs)
    /*30*/ {LL, IS_LOAD | WRITES_REG | STORES_IN_RT | ATOMIC | SIGN_EXTENDED, 0, 4, 0, OpType::LL},
    /*31*/ {LWCz, IS_LOAD | WRITES_REG | SIGN_EXTENDED | STORES_IN_RT | WRITES_CP, 0, 4, 1, OpType::LWCz},
    /*32*/ {LWCz, IS_LOAD | WRITES_REG | SIGN_EXTENDED | STORES_IN_RT | WRITES_CP, 0, 4, 2, OpType::LWCz},
    /*33*/ {},
    /*34*/ {LLD, IS_LOAD | WRITES_REG | STORES_IN_RT | ATOMIC, 0, 8, 0, OpType::LLD},
    /*35*/ {LDCz, WRITES_REG | IS_LOAD | SIGN_EXTENDED | WRITES_CP | STORES_IN_RT, 0, 8, 1, OpType::LDCz},
    /*36*/ {LDCz, WRITES_REG | IS_LOAD | SIGN_EXTENDED | WRITES_CP | STORES_IN_RT, 0, 8, 2, OpType::LDCz},
    /*37*/ {LD, IS_LOAD | SIGN_EXTENDED | WRITES_REG | STORES_IN_RT, 0, 8, 0, OpType::LD},
    /*38*/ {SC, IS_STORE | STORES_IN_RT | ATOMIC, 0, 4, 0, OpType::SC},
    /*39*/ {SWCz, IS_STORE | READS_CP, 0, 4, 1, OpType::SWCz},
    /*3A*/ {SWCz, IS_STORE | READS_CP, 0, 4, 2, OpType::SWCz},
    /*3B*/ {},
    /*3C*/ {SCD, IS_STORE | STORES_IN_RT | ATOMIC, 0, 8, 0, OpType::SCD},
    /*3D*/ {SDCz, IS_STORE | READS_CP, 0, 8, 1, OpType::SDCz},
 ...
 VR4300Cycle::OperationTemplate special_op_lut[64]{
    ...
    /*03*/ {SRA, WRITES_REG | STORES_IN_RD, 0, 0, 0, OpType::SRA},
    /*04*/ {SLLV, WRITES_REG | STORES_IN_RD, 0, 0, 0, OpType::SLLV},
    /*05*/ {},
    /*06*/ {SRLV, WRITES_REG | STORES_IN_RD, 0, 0, 0, OpType::SRLV},
    /*07*/ {SRAV, WRITES_REG | STORES_IN_RD, 0, 0, 0, OpType::SRAV},
    /*08*/ {JR, CAUSES_BRANCH_DELAY, 0, 0, 0, OpType::JR},
    /*09*/ {JALR, CAUSES_BRANCH_DELAY | STORES_IN_RD | WRITES_REG, 0, 0, 0, OpType::JALR},
    /*0A*/ {},
    /*0B*/ {},
    /*0C*/ {SYSCALL, CAUSED_EXCEPTION, 0, 0, 0, OpType::SYSCALL},
    /*0D*/ {BREAK, CAUSED_EXCEPTION, 0, 0, 0, OpType::BREAK},
    /*0E*/ {},
    /*0F*/ {SYNC, 0, 0, 0, 0, OpType::SYNC},
    /*10*/ {MFHI, WRITES_REG | STORES_IN_RD, 0, 0, 0, OpType::MFHI},
    /*11*/ {MTHI, WRITES_HI, 0, 0, 0, OpType::MTHI},
    /*12*/ {MFLO, WRITES_REG | STORES_IN_RD, 0, 0, 0, OpType::MFLO},
    /*13*/ {MTLO, WRITES_LO, 0, 0, 0, OpType::MTLO},
    /*14*/ {DSLLV, WRITES_REG | STORES_IN_RD, 0, 0, 0, OpType::DSLLV},
    /*15*/ {},
    /*16*/ {DSRLV, WRITES_REG | STORES_IN_RD, 0, 0, 0, OpType::DSRLV},
    /*17*/ {DSRAV, WRITES_REG | STORES_IN_RD, 0, 0, 0, OpType::DSRAV},
    /*18*/ {MULT, WRITES_HI | WRITES_LO, 5, 0, 0, OpType::MULT},
    /*19*/ {MULTU, WRITES_HI | WRITES_LO, 5, 0, 0, OpType::MULTU},
    /*1A*/ {DIV, WRITES_HI | WRITES_LO, 37, 0, 0, OpType::DIV},
    /*1B*/ {DIVU, WRITES_HI | WRITES_LO, 37, 0, 0, OpType::DIVU},
    /*1C*/ {DMULT, WRITES_HI | WRITES_LO, 8, 0,0, OpType::DMULT},
    /*1D*/ {DMULTU, WRITES_HI | WRITES_LO, 8, 0,0, OpType::DMULTU},
    /*1E*/ {DDIV, WRITES_HI | WRITES_LO, 69, 0,0, OpType::DDIV},
    /*1F*/ {DDIVU, WRITES_HI | WRITES_LO, 69, 0,0, OpType::DDIVU},
    /*20*/ {ADD, WRITES_REG | STORES_IN_RD | CAUSES_OVERFLOW_EXCEPTION, 0, 0,0, OpType::ADD},
    /*21*/ {ADDU, WRITES_REG | STORES_IN_RD, 0, 0,0, OpType::ADDU},
    /*22*/ {SUB, WRITES_REG | STORES_IN_RD | CAUSES_OVERFLOW_EXCEPTION, 0, 0,0, OpType::SUB},
    /*23*/ {SUBU, WRITES_REG | STORES_IN_RD, 0, 0,0, OpType::SUBU},
    /*24*/ {AND, WRITES_REG | STORES_IN_RD, 0, 0,0, OpType::AND},
    /*25*/ {OR, WRITES_REG | STORES_IN_RD, 0, 0,0, OpType::OR},
    /*26*/ {XOR, WRITES_REG | STORES_IN_RD, 0, 0,0, OpType::XOR},
    /*27*/ {NOR, WRITES_REG | STORES_IN_RD, 0, 0,0, OpType::NOR},
    /*28*/ {},
    /*29*/ {},
    /*2A*/ {SLT, WRITES_REG | STORES_IN_RD, 0, 0,0, OpType::SLT},
    /*2B*/ {SLTU, WRITES_REG | STORES_IN_RD, 0, 0,0, OpType::SLTU},
    /*2C*/ {DADD, WRITES_REG | STORES_IN_RD | CAUSES_OVERFLOW_EXCEPTION, 0, 0,0, OpType::DADD},
    /*2D*/ {DADDU, WRITES_REG | STORES_IN_RD, 0, 0,0, OpType::DADDU},
    /*2E*/ {DSUB, WRITES_REG | STORES_IN_RD | CAUSES_OVERFLOW_EXCEPTION, 0, 0,0, OpType::DSUB},
    /*2F*/ {DSUBU, WRITES_REG | STORES_IN_RD, 0, 0,0, OpType::DSUBU},
    /*30*/ {TGE, IS_TRAP, 0, 0,0, OpType::TGE},
    /*31*/ {TGEU, IS_TRAP, 0, 0,0, OpType::TGEU},
    /*32*/ {TLT, IS_TRAP, 0, 0,0, OpType::TLT},
    /*33*/ {TLTU, IS_TRAP, 0, 0,0, OpType::TLTU},
    /*34*/ {TEQ, IS_TRAP, 0, 0,0, OpType::TEQ},
    /*35*/ {},
    /*36*/ {TNE, IS_TRAP, 0, 0,0, OpType::TNE},
    /*37*/ {},
    /*38*/ {DSLL, WRITES_REG | STORES_IN_RD, 0, 0,0, OpType::DSLL},
    /*39*/ {},
    /*3A*/ {DSRL, WRITES_REG | STORES_IN_RD, 0, 0,0, OpType::DSRL},
    /*3B*/ {DSRA, WRITES_REG | STORES_IN_RD, 0, 0,0, OpType::DSRA},
    /*3C*/ {DSLL32, WRITES_REG | STORES_IN_RD, 0, 0,0, OpType::DSLL32},
    /*3D*/ {},
 ...
 VR4300Cycle::OperationTemplate regimm_op_lut[32]{
    ...
    /*03*/ {BGEZL, CAUSES_BRANCH_DELAY, 0, 0,0, OpType::BGEZL},
    /*04*/ {},
    /*05*/ {},
    /*06*/ {},
    /*07*/ {},
    /*08*/ {TGEI, IS_TRAP, 0, 0,0, OpType::TGEI},
    /*09*/ {TGEIU, IS_TRAP, 0, 0,0, OpType::TGEIU},
    /*0A*/ {TLTI, IS_TRAP, 0, 0,0, OpType::TLTI},
    /*0B*/ {TLTIU, IS_TRAP, 0, 0,0, OpType::TLTIU},
    /*0C*/ {TEQI, IS_TRAP, 0, 0,0, OpType::TEQI},
    /*0D*/ {},
    /*0E*/ {TNEI, IS_TRAP, 0, 0,0, OpType::TNEI},
    /*0F*/ {},
    /*10*/ {BLTZAL, CAUSES_BRANCH_DELAY | STORES_IN_31 | WRITES_REG, 0, 0,0,OpType::BLTZAL},
    /*11*/ {BGEZAL, CAUSES_BRANCH_DELAY | STORES_IN_31 | WRITES_REG, 0, 0,0,OpType::BGEZAL},
 ...
 VR4300Cycle::OperationTemplate COP0rs_op_lut[32]{
    ...
    /*03*/ {},
    /*04*/ {MTCz, WRITES_REG | WRITES_CP | STORES_IN_RD | CPZ, 0, 4,0, OpType::MTCz},
    /*05*/ {DMTCz, WRITES_REG | WRITES_CP | STORES_IN_RD | CPZ, 0, 8,0, OpType::DMTCz},
    /*06*/ {CTCz, WRITES_REG | WRITES_CP | CPControl | CPZ, 0, 0,0, OpType::CTCz},
    /*07*/ {},
    /*08*/ {},
    /*09*/ {},
    /*0A*/ {},
 ...
 VR4300Cycle::OperationTemplate COP1rs_op_lut[32]{
    ...
    /*03*/ {},
    /*04*/ {MTCz, WRITES_REG | WRITES_CP | STORES_IN_RD | CPZ, 0, 4,1, OpType::MTCz}, // (unchanged, already correct)
    /*05*/ {DMTCz, WRITES_REG | WRITES_CP | STORES_IN_RD | CPZ, 0, 8,1, OpType::DMTCz},
    /*06*/ {CTCz, WRITES_REG | WRITES_CP | CPControl | CPZ, 0, 0,1, OpType::CTCz},
    /*07*/ {},
    /*08*/ {},
    /*09*/ {},
    /*0A*/ {},
 ...
 VR4300Cycle::OperationTemplate COP0rt_op_lut[32]{
    ...
    /*03*/ {BCzTL, CAUSES_BRANCH_DELAY | CPZ, 0, 0,0, OpType::BCzTL},
    /*04*/ {},
    /*05*/ {},
    /*06*/ {},
    /*07*/ {},
 ...
 VR4300Cycle::OperationTemplate COP1rt_op_lut[32]{
    ...
    /*03*/ {BCzTL, CAUSES_BRANCH_DELAY | CPZ, 0, 0,1, OpType::BCzTL},
    /*04*/ {},
    /*05*/ {},
    /*06*/ {},
    /*07*/ {},
 ...
 VR4300Cycle::OperationTemplate CP0_op_lut[32]{
    ...
    /*04*/ {},
    /*05*/ {},
    /*06*/ {TLBWR, CPZ, 0, 0,0, OpType::TLBWR},
    /*07*/ {},
    /*08*/ {TLBP, WRITES_REG | WRITES_CP | CPZ, 0, 0,0, OpType::TLBP},
    /*09*/ {},
    /*0A*/ {},
    /*0B*/ {},
    /*0C*/ {},
 ...
 VR4300Cycle::OperationTemplate CP1_op_lut[64]{
    ...
    /*03*/ {DIVfmt, READS_CP | WRITES_CP | WRITES_REG | STORES_IN_SA | CPZ, 29, 8,1, OpType::DIVfmt},
    /*04*/ {SQRTfmt, READS_CP | WRITES_CP | WRITES_REG | STORES_IN_SA | CPZ, 29, 8,1, OpType::SQRTfmt},
    /*05*/ {ABSfmt, READS_CP | WRITES_CP | WRITES_REG | STORES_IN_SA | CPZ, 0, 8,1, OpType::ABSfmt},
    /*06*/ {MOVfmt, READS_CP | WRITES_CP | WRITES_REG | STORES_IN_SA | CPZ, 0, 8,1, OpType::MOVfmt},
    /*07*/ {NEGfmt, READS_CP | WRITES_CP | WRITES_REG | STORES_IN_SA | CPZ, 0, 8,1, OpType::NEGfmt},
    /*08*/ {ROUNDLfmt, WRITES_REG | WRITES_CP | STORES_IN_SA | READS_CP | CPZ, 5, 8,1, OpType::CVTSfmt},
    /*09*/ {TRUNCLfmt, WRITES_REG | WRITES_CP | STORES_IN_SA | READS_CP | CPZ, 5, 8,1, OpType::CVTSfmt},
    /*0A*/ {CEILLfmt, WRITES_REG | WRITES_CP | STORES_IN_SA | READS_CP | CPZ, 5, 8,1, OpType::CVTSfmt},
    /*0B*/ {FLOORLfmt, WRITES_REG | WRITES_CP | STORES_IN_SA | READS_CP | CPZ, 5, 8,1, OpType::CVTSfmt},
    /*0C*/ {ROUNDWfmt, WRITES_REG | WRITES_CP | STORES_IN_SA | READS_CP | CPZ, 5, 8,1, OpType::CVTSfmt},
    /*0D*/ {TRUNCWfmt, WRITES_REG | WRITES_CP | STORES_IN_SA | READS_CP | CPZ, 5, 8,1, OpType::CVTSfmt},
    /*0E*/ {CEILWfmt, WRITES_REG | WRITES_CP | STORES_IN_SA | READS_CP | CPZ, 5, 8,1, OpType::CVTSfmt},
    /*0F*/ {FLOORWfmt, WRITES_REG | WRITES_CP | STORES_IN_SA | READS_CP | CPZ, 5, 8,1, OpType::CVTSfmt},
    /*10*/ {},
    /*11*/ {},
    /*12*/ {},
    /*13*/ {},
    ...
    /*1E*/ {},
    /*1F*/ {},
    /*20*/ {CVTSfmt, WRITES_REG | WRITES_CP | STORES_IN_SA | READS_CP | CPZ, 5, 8,1, OpType::CVTSfmt},
    /*21*/ {CVTDfmt, WRITES_REG | WRITES_CP | STORES_IN_SA | READS_CP | CPZ, 5, 8,1, OpType::CVTDfmt},
    /*22*/ {},
    /*23*/ {},
    /*24*/ {CVTWfmt, WRITES_REG | WRITES_CP | STORES_IN_SA | READS_CP | CPZ, 5, 8,1, OpType::CVTWfmt},
    /*25*/ {CVTLfmt, WRITES_REG | WRITES_CP | STORES_IN_SA | READS_CP | CPZ, 5, 8,1, OpType::CVTLfmt},
    /*26*/ {},
    /*27*/ {},
    /*28*/ {},
    /*29*/ {},
    ...
    /*2E*/ {},
    /*2F*/ {},
    /*30*/ {Ccondfmt, READS_CP | CPZ, 0, 8,1, OpType::Ccondfmt},
    /*31*/ {Ccondfmt, READS_CP | CPZ, 0, 8,1, OpType::Ccondfmt},
    /*32*/ {Ccondfmt, READS_CP | CPZ, 0, 8,1, OpType::Ccondfmt},
    /*33*/ {Ccondfmt, READS_CP | CPZ, 0, 8,1, OpType::Ccondfmt},
    /*34*/ {Ccondfmt, READS_CP | CPZ, 0, 8,1, OpType::Ccondfmt},
    /*35*/ {Ccondfmt, READS_CP | CPZ, 0, 8,1, OpType::Ccondfmt},
    /*36*/ {Ccondfmt, READS_CP | CPZ, 0, 8,1, OpType::Ccondfmt},
    /*37*/ {Ccondfmt, READS_CP | CPZ, 0, 8,1, OpType::Ccondfmt},
    /*38*/ {Ccondfmt, READS_CP | CPZ, 0, 8,1, OpType::Ccondfmt},
    /*39*/ {Ccondfmt, READS_CP | CPZ, 0, 8,1, OpType::Ccondfmt},
    /*3A*/ {Ccondfmt, READS_CP | CPZ, 0, 8,1, OpType::Ccondfmt},
    /*3B*/ {Ccondfmt, READS_CP | CPZ, 0, 8,1, OpType::Ccondfmt},
    /*3C*/ {Ccondfmt, READS_CP | CPZ, 0, 8,1, OpType::Ccondfmt},
    /*3D*/ {Ccondfmt, READS_CP | CPZ, 0, 8,1, OpType::Ccondfmt},
    /*3E*/ {Ccondfmt, READS_CP | CPZ, 0, 8,1, OpType::Ccondfmt},
    /*3F*/ {Ccondfmt, READS_CP | CPZ, 0, 8,1, OpType::Ccondfmt},
};
