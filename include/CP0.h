...
#define CAUSE_IP_TIMER_SHIFT 15
#define CAUSE_IP_TIMER_MASK (1 << CAUSE_IP_TIMER_SHIFT)
...
#define STATUS_IM_MASK (0xFF << STATUS_IM_SHIFT)
#define STATUS_IE_SHIFT 0
#define STATUS_IE_MASK 1
...
public:
    ...
    uint64_t write_masks[32]={
        ...
        0xFFFFFFFFFFFFFFF0ULL,//xcontext
        0xFFFFFFFFFFFFFFFFULL,//r21
        0xFFFFFFFFFFFFFFFFULL,//r22
        0xFFFFFFFFFFFFFFFFULL,//r23
        0xFFFFFFFFFFFFFFFFULL,//r24
        0xFFFFFFFFFFFFFFFFULL,//r25
        0x00000000000000FFULL,//parityError
        0x0000000000000000ULL,//cacheErr
        0xFFFFFFFF0FFFFFC0ULL,//tagLo
        0x0000000000000000ULL,//tagHi
        0xFFFFFFFFFFFFFFFFULL,//errorEPC
