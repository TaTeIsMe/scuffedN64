...
/*1A*/ {LDL, IS_LOAD | ACCESSES_DOUBLE_WORD | WRITES_REG | STORES_IN_RT, 0, OpType::LDL},
/*1B*/ {LDR, IS_LOAD | ACCESSES_DOUBLE_WORD | WRITES_REG | STORES_IN_RT, 0, OpType::LDR},
...
/*20*/ {LB, IS_LOAD | ACCESSES_BYTE | WRITES_REG | STORES_IN_RT | SIGN_EXTENDED,0,OpType::LB},
/*21*/ {LH, IS_LOAD | ACCESSES_HALF_WORD | WRITES_REG | STORES_IN_RT | SIGN_EXTENDED,0,OpType::LH},
/*22*/ {LWL, IS_LOAD | ACCESSES_WORD | WRITES_REG | STORES_IN_RT | LEFT_ACCESS,0,OpType::LWL},
/*23*/ {LW, IS_LOAD | ACCESSES_WORD | WRITES_REG | STORES_IN_RT,0,OpType::LW},
...
/*31*/ {LWCz, IS_LOAD | WRITES_REG | STORES_IN_RT | WRITES_CP,0, OpType::LWCz},
/*32*/ {LWCz, IS_LOAD | WRITES_REG | STORES_IN_RT | WRITES_CP,0, OpType::LWCz},
/*33*/ {},

/*34*/ {LLD, IS_LOAD | ACCESSES_DOUBLE_WORD | WRITES_REG | STORES_IN_RT | ATOMIC,0,OpType::LLD},
/*35*/ {LDCz, WRITES_REG | IS_LOAD | WRITES_CP | STORES_IN_RT ,0,OpType::LDCz},
/*36*/ {LDCz, WRITES_REG | IS_LOAD | WRITES_CP | STORES_IN_RT ,0,OpType::LDCz},
/*37*/ {LD, IS_LOAD | ACCESSES_DOUBLE_WORD | WRITES_REG | STORES_IN_RT,0,OpType::LD},
